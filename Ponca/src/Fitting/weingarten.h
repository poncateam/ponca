...
protected:
    enum
    {
        Check = Base::PROVIDES_FIRST_FUNDAMENTAL_FORM_COMPONENTS && Base::PROVIDES_SECOND_FUNDAMENTAL_FORM_COMPONENTS,
...
/*!
    ...
    (h(u,v), u, v) because CovariancePlaneFitImpl::worldToTangentPlane() wraps up coordinates in this order (height, u
   and v).
