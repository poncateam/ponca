...
template <class DataPoint, class _NFilter, typename T>
typename CovarianceFitBase<DataPoint, _NFilter, T>::Scalar CovarianceFitBase<DataPoint, _NFilter, T>::planarity() const
{
    return (m_solver.eigenvalues()(1) - m_solver.eigenvalues()(0)) / m_solver.eigenvalues()(2);
}

template <class DataPoint, class _NFilter, typename T>
typename CovarianceFitBase<DataPoint, _NFilter, T>::Scalar CovarianceFitBase<DataPoint, _NFilter, T>::linearity() const
{
    return (m_solver.eigenvalues()(2) - m_solver.eigenvalues()(1)) / m_solver.eigenvalues()(2);
}

template <class DataPoint, class _NFilter, typename T>
typename CovarianceFitBase<DataPoint, _NFilter, T>::Scalar CovarianceFitBase<DataPoint, _NFilter, T>::sphericity() const
{
    return (m_solver.eigenvalues()(0)) / m_solver.eigenvalues()(2);
}

template <class DataPoint, class _NFilter, typename T>
typename CovarianceFitBase<DataPoint, _NFilter, T>::Scalar CovarianceFitBase<DataPoint, _NFilter, T>::anisotropy() const
{
    return (m_solver.eigenvalues()(2) - m_solver.eigenvalues()(0)) / m_solver.eigenvalues()(2);
}

template <class DataPoint, class _NFilter, typename T>
typename CovarianceFitBase<DataPoint, _NFilter, T>::Scalar CovarianceFitBase<DataPoint, _NFilter, T>::eigenentropy() const
{
...
template <class DataPoint, class _NFilter, typename T>
typename CovarianceFitBase<DataPoint, _NFilter, T>::Scalar CovarianceFitBase<DataPoint, _NFilter, T>::lambda_0() const
{
    return m_solver.eigenvalues()(0);
}

template <class DataPoint, class _NFilter, typename T>
typename CovarianceFitBase<DataPoint, _NFilter, T>::Scalar CovarianceFitBase<DataPoint, _NFilter, T>::lambda_1() const
{
    return m_solver.eigenvalues()(1);
}

template <class DataPoint, class _NFilter, typename T>
typename CovarianceFitBase<DataPoint, _NFilter, T>::Scalar CovarianceFitBase<DataPoint, _NFilter, T>::lambda_2() const
{
