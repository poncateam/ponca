...
void
MongePatchQuadraticFitImpl<DataPoint, _WFunctor, T>::init()
{
    Base::init();
...
template < class DataPoint, class _WFunctor, typename T>
bool
MongePatchQuadraticFitImpl<DataPoint, _WFunctor, T>::addLocalNeighbor(Scalar w,
...
template < class DataPoint, class _WFunctor, typename T>
FIT_RESULT
MongePatchQuadraticFitImpl<DataPoint, _WFunctor, T>::finalize ()
{
