...
public:
    ...
    PONCA_MULTIARCH [[nodiscard]] bool operator==(const CNC& other) const
    {
        ...
        return (m_eCurrentState == other.m_eCurrentState) && (kMean() == other.kMean()) && (kmin() == other.kmin()) &&
               (kmax() == other.kmax()) && (kminDirection() == other.kminDirection()) &&
               (kmaxDirection() == other.kmaxDirection()) && (GaussianCurvature() == other.GaussianCurvature()) &&
               (m_T11 == other.m_T11) && (m_T12 == other.m_T12) && (m_T13 == other.m_T13) && (m_T22 == other.m_T22) &&
               (m_T23 == other.m_T23) && (m_T33 == other.m_T33);
    }
