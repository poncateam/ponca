                                                   ...
                                                   const bool _bAddPositionNoise = true)
{
    ...
    {
        vRandomPosition =
            vRandomPosition + VectorType::Random().normalized() * Eigen::internal::random<Scalar>(0., 1. - MIN_NOISE);
    }
...
[[nodiscard]] DataPoint getPointOnPlane(const typename DataPoint::VectorType _vPosition,
                                        const typename DataPoint::VectorType _vNormal,
                                        const typename DataPoint::Scalar _radius, const bool _bAddPositionNoise = true,
                                        const bool _bAddNormalNoise = true, const bool _bReverseNormals = false)
{
    typedef typename DataPoint::Scalar Scalar;
    typedef typename DataPoint::VectorType VectorType;
...
template <typename Scalar>
[[nodiscard]] inline Scalar getParaboloidZ(Scalar _x, Scalar _y, Scalar _a, Scalar _b, Scalar _c, Scalar _d, Scalar _e,
                                           Scalar _f)
{
 ...
 */
template <typename DataPoint>
[[nodiscard]] DataPoint getPointOnParaboloid(const typename DataPoint::Scalar _a, const typename DataPoint::Scalar _b,
...
{
    return getPointOnParaboloid<DataPoint>(_params(0), _params(1), _params(2), _params(3), _params(4), _params(5), _s,
                                           _bAddNoise);
}
