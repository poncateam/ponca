...
#define _PONCA_BASKET_X(name, desc, ...) _INSTANTIATE_PONCA_EXTERN template class _PONCA_EXPORT __VA_ARGS__;
#define _PONCA_BASKET_DIFF_X(name, desc, ...) _INSTANTIATE_PONCA_EXTERN template class _PONCA_EXPORT __VA_ARGS__;
