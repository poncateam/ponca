...
//KdTreeRangePointQuery<DataPoint>::KdTreeRangePointQuery() :
//    KdTreeQuery(),
//    RangePointQuery<DataPoint>()
//{
//    cout << "Test" << endl;
//}
//
//template <class DataPoint>
//KdTreeRangePointQuery<DataPoint>::KdTreeRangePointQuery(const KdTree<DataPoint> * kdtree) :
//    KdTreeQuery(kdtree),
//    RangePointQuery<DataPoint>()
//{
//}
//
//template <class DataPoint>
//KdTreeRangePointQuery<DataPoint>::KdTreeRangePointQuery(const KdTree<DataPoint>* kdtree, DataPoint::Scalar radius) :
//    KdTreeQuery(kdtree),
//    RangePointQuery<DataPoint>(radius)
//{
//}
//
//template <class DataPoint>
//KdTreeRangePointQuery<DataPoint>::KdTreeRangePointQuery(const KdTree<DataPoint>* kdtree, DataPoint::Scalar radius, const DataPoint::VectorType& point) :
//    KdTreeQuery(kdtree),
//    RangePointQuery<VectorType>(radius, point)
//{
//}
//
//KdTreeRangePointIterator<VectorType> KdTreeRangePointQuery<VectorType>::begin()
//{
...
//}
//
//KdTreeRangePointIterator<VectorType> KdTreeRangePointQuery<VectorType>::end()
//{
